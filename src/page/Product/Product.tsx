      ...
      <div className='product-page'>
        ...
        <div className='product-page__content'>
          ...
          <div className='product-page__status'>
            ...
            <h4 className='product-page__status-text'>Imported</h4>
          </div>
          <hr className='product-page__line' />
          ...
          <p className='product-page__warn-message'>
            Note: Products here are sold at a discount price as wholesale. The original price is the price at which the product was
            sold before the discount. The discount price is the price at which the product is currently being sold.
          </p>
        </div>
      </div>
      <hr className='product-page__line' />
